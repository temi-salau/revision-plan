...
const plan = [
  ...
  { day: "Thu 30 Apr", phase: "CS3920", tasks: ["ML revision session 9–11am", "Comp Finance revision session 4–6pm", "Sister's 18th — light day, sessions are the work"], hours: 3, note: "🎂 Sister's 18th · ML session 9–11am · CF session 4–6pm" },
  { day: "Fri 1 May", phase: "CS3920", tasks: ["Full ML past paper timed", "Fix gaps, targeted weak topics"], hours: 6 },
  { day: "Sat 2 May", phase: "BUFFER", tasks: ["Overflow day — use for whichever of Finance / IA / ML needs it most", "No new content, consolidation only"], hours: 5 },
  { day: "Sun 3 May", phase: "CS3930", tasks: ["Comp Finance final review — key formulas, one paper skim", "Rest in the evening"], hours: 4, note: "Keep it light" },
  { day: "Mon 4 May", phase: "CS3930", tasks: ["Light refresh only — no new content", "Rest and sleep well"], hours: 2 },
  { day: "Tue 5 May", phase: "CS3930", tasks: ["Morning: final skim of notes", "Afternoon: rest"], hours: 2, note: "Exam tomorrow" },
  { day: "Wed 6 May", phase: "CS3940", tasks: ["EXAM: Computational Finance", "Evening: light IA refresh if energy allows"], hours: 2, note: "🎓 Comp Finance exam" },
  { day: "Thu 7 May", phase: "CS3940", tasks: ["IA final consolidation — past paper review, weak spots"], hours: 5 },
  { day: "Fri 8 May", phase: "CS3940", tasks: ["IA + quick Quantum scan (should be fast for you)", "Quantum: one past paper"], hours: 6 },
  { day: "Sat 9 May", phase: "CS3600", tasks: ["Quantum consolidation — circuits, algorithms, complexity", "Light IA refresh"], hours: 5 },
  { day: "Sun 10 May", phase: "CS3940", tasks: ["Final IA prep", "Rest"], hours: 3, note: "Keep it easy" },
  { day: "Mon 11 May", phase: "CS3600", tasks: ["EXAM: Intelligent Agents", "Afternoon: Quantum final skim"], hours: 2, note: "🎓 IA exam" },
  { day: "Tue 12 May", phase: "CS3920", tasks: ["EXAM: Quantum Computation", "Evening: begin ML final prep"], hours: 2, note: "🎓 Quantum exam" },
  { day: "Wed 13 May", phase: "CS3920", tasks: ["ML final push — consolidate, targeted weak areas", "One more past paper"], hours: 6 },
  { day: "Thu 14 May", phase: "CS3510", tasks: ["EXAM: Machine Learning", "Evening off — you've earned it"], hours: 1, note: "🎓 ML exam" },
  { day: "Fri 15 May", phase: "CS3510", tasks: ["Functional Programming: past papers first", "Haskell patterns + key concepts refresh"], hours: 5 },
  { day: "Sat 16 May", phase: "CS3510", tasks: ["Functional deep dive if needed, else practice questions", "Should be light given your comfort level"], hours: 4 },
  { day: "Sun 17 May", phase: "CS2860", tasks: ["Advanced Algorithms: past papers scan", "Core topics: complexity classes, reductions, graph algorithms"], hours: 5, note: "Flex day" },
  { day: "Mon 18 May", phase: "CS2860", tasks: ["Adv Alg: deep dive on hardest topics", "Practice proofs/reductions"], hours: 5, note: "Flex day" },
  { day: "Tue 19 May", phase: "CS3510", tasks: ["Functional final light refresh", "Adv Alg continued if needed"], hours: 4, note: "Tutoring 5:30–6:30" },
  { day: "Wed 20 May", phase: "CS3003", tasks: ["EXAM: Functional Programming", "IT Project Management: begin scan — should be mostly comprehension"], hours: 3, note: "🎓 Functional exam" },
  { day: "Thu 21 May", phase: "CS3003", tasks: ["IT PM: past papers + core frameworks (PRINCE2, Agile, risk mgmt)", "Should be quick given 50% CW already done"], hours: 4 },
  { day: "Fri 22 May", phase: "CS2860", tasks: ["Advanced Algorithms: full past paper timed", "Fix any weak proofs"], hours: 6 },
  { day: "Sat 23 May", phase: "CS3950", tasks: ["Deep Learning: past papers scan", "Core topics: CNNs, RNNs, LSTMs, backprop, regularisation"], hours: 6 },
  { day: "Sun 24 May", phase: "CS3950", tasks: ["Deep Learning: solidify understanding — you have prior coursework here", "Practice questions"], hours: 5, note: "Flex day" },
  { day: "Mon 25 May", phase: "CS3003", tasks: ["IT PM final light refresh", "Adv Alg light consolidation"], hours: 4, note: "Flex day" },
  { day: "Tue 26 May", phase: "CS2860", tasks: ["EXAM: IT Project Management", "Adv Alg final prep"], hours: 3, note: "🎓 IT PM exam" },
  { day: "Wed 27 May", phase: "CS3950", tasks: ["EXAM: Advanced Algorithms", "Deep Learning final prep"], hours: 3, note: "🎓 Adv Alg exam" },
  { day: "Thu 28 May", phase: "CS3950", tasks: ["Deep Learning final consolidation — key architectures, exam Q types", "Rest well"], hours: 4 },
  { day: "Fri 29 May", phase: "CS3950", tasks: ["EXAM: Deep Learning 🎉"], hours: 1, note: "🎓 Deep Learning exam — done!" },
];
